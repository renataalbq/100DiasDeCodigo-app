...
const ProfileInfo: React.FC<ProfileInfoProps> = props => {
  ...
  return (
    <View style={{ backgroundColor: '#0d0d0df8' }}>
      ...
      <Container
        style={{ paddingHorizontal: 10, paddingTop: 20, marginHorizontal: 10 }}
      >
      ...
      {!openInput ? (
        <Container
          style={{ paddingHorizontal: 10, marginTop: 4, marginHorizontal: 10 }}
        >
          <View>
            <View style={{ flexDirection: 'row', gap: 230 }}>
              ...
              <WhiteText
                style={{ marginTop: 15, marginBottom: 7, fontSize: 14 }}
              >
                {props.currentDay}/100
              </WhiteText>
            </View>
          ...
          <View style={{ flexDirection: 'row', gap: 20, marginTop: 10 }}>
            <View style={{ flexDirection: 'row', gap: 10 }}>
              ...
              <WhiteText
                style={{ marginBottom: 10, paddingTop: 1, fontSize: 14 }}
              >
                {props.numberOfLikes}
              </WhiteText>
            </View>
            <View style={{ flexDirection: 'row', gap: 10 }}>
              ...
              <WhiteText style={{ marginBottom: 10, fontSize: 14 }}>
