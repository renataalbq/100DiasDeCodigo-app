...
import { Container, ContainerRow, WhiteText } from './profile-info.style';
        ...
        <View style={{backgroundColor: '#0d0d0df8' }}>
            <ContainerRow>
              ...
              <View style={{marginLeft: 20}}>
               <WhiteText style={{fontSize: 24,fontWeight: 'bold',marginTop: 10}}>
                {props.name}
                </WhiteText>
                <WhiteText style={{fontSize: 16, color: 'gray', marginBottom: 15 }}>
                  @{props.username}
                </WhiteText>
                </View>
            </ContainerRow>
              ...
              <Container style={{ paddingHorizontal: 10, marginTop: 7}}>
                <View>
                  <View  style={{flexDirection: 'row', gap: 240}}>
                    <WhiteText style={{ marginTop: 15, marginBottom: 8, fontSize: 16, fontWeight: 'bold' }}>
                        Progresso 
                    </WhiteText>
                    <WhiteText style={{ marginTop: 15, marginBottom: 7, fontSize: 14}}>
                        20/100 
                    </WhiteText>
                  </View>
                ...
                <View style={{flexDirection: 'row', gap: 20, marginTop: 10}}>
                  <View style={{flexDirection: 'row', gap: 10}}>
                    <AntDesign name="heart" size={18}  color={'#b6b6b6'} />
                      <WhiteText style={{ marginBottom: 10, paddingTop:1, fontSize: 14 }}>
                      34
                    </WhiteText>
                  </View>
                  <View style={{flexDirection: 'row', gap: 10}}>
                    <FontAwesome name="comments" size={18} color={'#b6b6b6'} />
                    <Text style={{ color: '#080808', marginBottom: 10, paddingTop:1, fontSize: 14 }}>
                      50
                    </Text>
                  </View>
                </View>
